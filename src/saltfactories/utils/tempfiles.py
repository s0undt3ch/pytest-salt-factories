...
class SaltEnv:
    ...
    name: str = attr.ib()
    paths: List[pathlib.Path] = attr.ib(default=attr.Factory(list))
    ...
    def temp_file(
        self, name: str, contents: Optional[str] = None, strip_first_newline: bool = True
