...
class Sshd(Daemon):
    ...
    def __attrs_post_init__(self):
        ...
        authorized_keys_file.chmod(384)
    ...
    def _generate_client_ecdsa_key(self):
        ...
        key_path_pub = self.config_dir / '{0}.pub'.format(key_filename)
